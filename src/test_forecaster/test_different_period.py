...
# File name: test_different_period
# Author: Mark Wang
# Date: 8/11/2016
...
start_date = datetime.datetime(2011, 01, 06)
end_date = datetime.datetime(2013, 07, 06)
test_date = datetime.datetime(2012, 07, 06)
delta_date = relativedelta(months=6)
worker_number = 3
window_size = 6
...
if __name__ == '__main__':
    ...
    while end_date < datetime.datetime(2016, 07, 07):

        path = os.path.join(result_path, 'different_period', start_date.strftime('%Y%m%d'))
